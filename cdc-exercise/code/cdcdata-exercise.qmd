...
str(ferret_IAV_data)
summary(ferret_IAV_data) #logicals are locicals and factors are factors, both with count information
...
How many highly virulent strains have the weird molecular thing going on? 


Okay, now that that is over - 

1) Diveristy of NA and HA; how many combinations, and representation of each combination? 
...
5)plotting time series of viral titres for each ferret!