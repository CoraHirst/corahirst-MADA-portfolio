...
colnames(mydata) <- c("Height", "Weight", "Gender", "Cat_breed", "Cat_age")
...
############################
#### Third model fit
# fit linear model using height as outcome, cat breed and age as predictor

lmfit3 <- lm(Height ~ Cat_breed + Cat_age, mydata)  
