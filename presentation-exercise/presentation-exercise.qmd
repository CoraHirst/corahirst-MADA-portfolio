...
In this exercise, I would like to try to recreate THIS FIGURE. 
...
scores_state2023 = read.csv(here::here("presentation-exercise", "data", "seda2023_state_ys.csv")) #test score data by state

# load mean scores by counties within states
scores_admindis2023 = read.csv(here::here("presentation-exercise", "data", "seda2023_admindist_ys.csv")) #test score data by county 
```
